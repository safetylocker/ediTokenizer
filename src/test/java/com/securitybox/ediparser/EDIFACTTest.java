...
public class EDIFACTTest {
    ...
    public void docuemntHandler() throws NoSuchAlgorithmException, JSONException {
        ...
        //Segment specification using less values than 10
        JSONObject jsonObject8 = new JSONObject();
        jsonObject8.put(Constants.EDIFACT_SEGMENT_NAME,"FTX");
        jsonObject8.put(Constants.EDIFACT_SEGMENT_QUALIFIER,"AAA");
        jsonObject8.put(Constants.EDIFACT_DATA_ELEMENT_NUMBER,5);
        jsonObject8.put(Constants.EDIFACT_DATA_ELEMENT_POSITION,1);
        jsonObject8.put(Constants.EDIFACT_DATA_ELEMENT_LENGTH,5);;
        objectToTokenized.put(jsonObject8);
        ...
        String completeEDIFACT ="UNA:+.? 'UNB+UNOC:3+PartnerA+PartnerB+100615:0100+1006150100000++MYCOMPANY'UNH+1+IFTMIN:S:93A:UN'BGM+340+0000001339+9'DTM+137:20100615:102'TSR+PCO'FTX+DIN+++Delivery information'CNT+7:7.000:KGM'CNT+26:0.500:MTQ'CNT+ZLM:0.40:MTR'CNT+Z12:3:PCE'CNT+11:3:PCE'RFF+AAO:Receivers reference'RFF+CU:Shipment reference'TDT+20'NAD+CZ+123456++MYCOMPANY AB+Box 2326 +GEBORG++40315+SE'CTA+IC+:John Doe'COM+031-581600:TE'COM+031-7581605:FX'COM+info@MYCOMPANY.com:EM'NAD+CN+++Testmottagaren AB+Sdervsvn 12 +VTRA FRUNDA++42651+SE'CTA+IC+:Bjrn Svensson'COM+012-3456789:TE'COM+012-9876543:FX'COM+test@test.com:EM'COM+07353289222:ZMS'GID+1+1:CT'FTX+AAA+++Electronics'FTX+PAC+++9'MEA+WT++KGM:5.000'MEA+VOL++MTQ:0.300'PCI+18+373925550000420599'GID+2+2:CT'FTX+AAA+++Electronics'FTX+PAC+++9'MEA+WT++KGM:2.000'MEA+VOL++MTQ:0.200'PCI+18+373925550000420605:373925550000420612'EQD+EFP'EQN+1'UNT+39+1'UNZ+1+1006150100000'";String oneLineSegment = "UNA:+.? 'UNB+UNOC:3+Patner1+Patner2+100615:0100+1006150100000++Patner1'NAD+CN+++Testmottagaren AB+Sdervsvn 12 +VTRA FRUNDA++42651+SE'RFF+AAO:Receivers reference'RFF+CU:Shipment reference'FTX+DIN+++Delivery information'";
