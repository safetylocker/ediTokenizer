...
public class EDIFACTTest {
    ...
    public void docuemntHandler() throws NoSuchAlgorithmException, JSONException {
       ...
       /* JSONObject jsonObject = new JSONObject();
        ...
        String oneLineSegment = "UNA:+.? 'UNB+UNOC:3+Patner1+Patner2+100615:0100+1006150100000++Patner1'NAD+CN+++Testmottagaren AB+Sdervsvn 12 +VTRA FRUNDA++42651+SE'RFF+AAO:Receivers reference'RFF+CU:Shipment reference'";
