...
public class EdiDocumentParserTester {
    ...
    public void name() throws JSONException, NoSuchAlgorithmException {
        ...
        receiver.add("clientB");
         String tmp,tmp1 = "";
//         tmp = edifact.docuemntHandler(Constants.TOKENIZER_METHOD_TOKENIZE,objectToTokenized,"NAD+CN+++Testmottagaren AB+Sdervsvn 12 +VTRA FRUNDA++42651+SE'",sender,receiver);
